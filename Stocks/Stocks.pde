...
float money = 5000; //starting cash
float symCost = 0; //value of stocks cost
float total = 0;  String[] prices2;
...
//String valueOfStock; //used in SellMenu to display cost of the stocks
...
//int[] wait = new int[10];
float[] prices = new float[10]; //collection of API calls or random prices
